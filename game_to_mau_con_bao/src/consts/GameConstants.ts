...
export const GameConstants = {
    ...
    // =========================================
    PALETTE_DATA: [
        { key: TextureKeys.BtnS1_1, color: 0xFCC074 },
        { key: TextureKeys.BtnS1_2, color: 0xFAC3C1 }, 
        { key: TextureKeys.BtnS1_3, color: 0xFAF1A6 },
        { key: TextureKeys.BtnS1_4, color: 0xAE7328 }, 
        { key: TextureKeys.BtnS1_5, color: 0x2F59FF },    
    ],
