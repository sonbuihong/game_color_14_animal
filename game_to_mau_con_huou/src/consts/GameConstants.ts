...
export const GameConstants = {
    ...
    // =========================================
    PALETTE_DATA: [
        { key: TextureKeys.BtnS1_1, color: 0xF8AC7A },
        { key: TextureKeys.BtnS1_2, color: 0xB58062 },
        { key: TextureKeys.BtnS1_3, color: 0xFAE3BA },
        { key: TextureKeys.BtnS1_4, color: 0xB2CB4B },
        { key: TextureKeys.BtnS1_5, color: 0xEC905B }, 
    ],
