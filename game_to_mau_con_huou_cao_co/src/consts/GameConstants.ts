...
export const GameConstants = {
    ...
    // =========================================
    PALETTE_DATA: [
        { key: TextureKeys.BtnS1_1, color: 0xFAEF66 },
        { key: TextureKeys.BtnS1_2, color: 0xFBCB7A }, 
        { key: TextureKeys.BtnS1_3, color: 0x387440 },
        { key: TextureKeys.BtnS1_4, color: 0xA8A994 }, 
        { key: TextureKeys.BtnS1_5, color: 0xB2CB4B },    
    ],
