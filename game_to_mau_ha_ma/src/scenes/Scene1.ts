...
export default class Scene1 extends Phaser.Scene {
    ...
    create() {
        ...
        // this.playIntroSequence(); // Đã chuyển sang lick-to-start
        ...
        game.setTotal(this.totalParts); // Theo yêu cầu đề bài: setTotal(5) dù thực tế có 2 part
...
// --- LOGIC TẠO LEVEL THEO STAGE ---
    ...
    private showHint() {
        ...
        game.addHint(); // Track số lần gợi ý
        ...
        if (hintPoints && hintPoints.length > 0) {
            ...
            tweensChain.push({ alpha: 0, duration: IDLE_CFG.FADE_OUT });
             ...
             // Logic mặc định (chỉ 1 điểm center)
             startHintX = destX;
             startHintY = destY;
