...
export const GameConstants = {
    ...
    // =========================================
    PALETTE_DATA: [
        { key: TextureKeys.BtnS1_1, color: 0xAE816C },
        { key: TextureKeys.BtnS1_2, color: 0xF0DCC2 }, 
        { key: TextureKeys.BtnS1_3, color: 0x000000 },
        { key: TextureKeys.BtnS1_4, color: 0xB2CB4B }, 
        { key: TextureKeys.BtnS1_5, color: 0xDD878E },    
    ],
