...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_Board, 'assets/images/bg/board.png');

        // - Con Gấu (Mapped to S1 Keys)
        this.load.image(TextureKeys.S1_Template, 'assets/images/S1/template.png');
        ...
        this.load.image(TextureKeys.BtnS1_2, 'assets/images/color/color2.png');
        this.load.image(TextureKeys.BtnS1_3, 'assets/images/color/color3.png');
        this.load.image(TextureKeys.BtnS1_4, 'assets/images/color/color4.png');
        this.load.image(TextureKeys.BtnS1_5, 'assets/images/color/color5.png');
